...
if mode=="Upload csv":
    ...
    if uploaded_csv_judge:
        ...
        st.write(f"Read {df_judge.shape[0]} rows and {df_judge.shape[0]} columns of data")
    ...
    if uploaded_csv_judgment:
        ...
        st.write(f"Read {df_judgment.shape[0]} rows and {df_judgment.shape[0]} columns of data")
    ...
    if uploaded_csv_text:
        ...
        st.write(f"Read {df_text.shape[0]} rows and {df_text.shape[0]} columns of data")
